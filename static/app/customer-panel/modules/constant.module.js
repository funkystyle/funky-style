angular.module("constantModule", [])
    ...
    .constant('URL', {
        ...
        deals: "/api/1.0/deals",
        categories: '/api/1.0/categories?embedded={"related_categories":1, "top_categories":1, "top_stores":1}',
        coupons: '/api/1.0/coupons?embedded={"recommended_stores":1, "related_categories":1, "related_stores":1}',
        stores: '/api/1.0/stores?embedded={"recommended_stores":1, "related_categories":1, "related_stores":1}',
