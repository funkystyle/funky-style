angular.module("dealCategoriesModule", ['angular-table', 'constantModule', 'toastr', 'cgBusy',
    'satellizer', 'ui.select', 'dealFactoryModule'])
    .controller("dealCategoriesCtrl", function ($scope, $filter, toastr, mainURL, URL, $state, $stateParams,
                                                $auth, dealFactory, $q) {
        $scope.categories = [];
